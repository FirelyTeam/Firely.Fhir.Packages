...
namespace Firely.Fhir.Packages
{
    ...
    public class PackageManifest
    {
        ...
        /// It's fairly random, so please do depend on it. Not that the HL7 IG build tool
        /// also creates template and tool packages and publishes them as a FHIR package
